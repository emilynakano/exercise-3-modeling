...
CREATE TABLE "customerPhone" ("id" SERIAL PRIMARY KEY, "customerId" INTEGER NOT NULL REFERENCES "customers" ("id"), "number" INTEGER NOT NULL UNIQUE, "type" ENUM('landline', 'mobile') NOT NULL
);
...
CREATE TABLE "transactions" ("id" SERIAL PRIMARY KEY, "customerId" INTEGER NOT NULL REFERENCES "bankAccount" ("id"), "amount" INTEGER NOT NULL, "type" ENUM('deposit', 'withdraw') NOT NULL, "time" TIME NOT NULL, "description" TEXT, "cancelled" BOOL NOT NULL DEFAULT FALSE);
